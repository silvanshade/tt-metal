...
class Qwen36ModelArgs(ModelArgs):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # the interleaved-mrope cos/sin (modeling_qwen3_5.Qwen3_5RotaryEmbedding). The
        ...
        # rope_type "default" (the shipped config) is plain RoPE; "yarn" (factor +
        # original_max_position_embeddings in rope_parameters) extends the position window, and
        # rope.rope_inv_freq derives both the blended inv_freq and the cos/sin attention scaling.
        self.rope_scaling_params = dict(rope_params) if rope_params.get("rope_type", "default") != "default" else None
